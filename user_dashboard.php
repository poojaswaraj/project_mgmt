...
if(!isset($_SESSION['login_user']))
{
  ...
  $user_id=$_SESSION['login_user'];
   $sql=mysql_query("SELECT * FROM user a INNER JOIN mst_employee b ON a.id=b.user_id WHERE b.id='$user_id'");
...
<body>
    ...
    $user_id=$_SESSION['login_user'];
     ...
     $sub=mysql_query("SELECT * FROM mst_employee WHERE id='$user_id'")or die(mysql_error());
     ...
     <?php } ?>
       ...
       <div class="setting">
           <div class="setting-sub">
			   ...
			   $query=mysql_query("SELECT * FROM mst_employee WHERE id='".$_SESSION['login_user']."'");
               ...
               <span class="setting-part"><a href="logout.php" title='Logout'><span class="glyphicon glyphicon-off"></span>&nbsp;</a></span>
            </div>
       </div>
    </div>
    <nav class="navbar navbar-inverse navbar-fixed-top nav-menu" role="navigation">
        <div class="container">
            ...
            <?php 
            error_reporting(0);
            $aa1 = mysql_query("SELECT * FROM mst_employee WHERE id='$user_id'")or die(mysql_error($connection));
                $rr=mysql_fetch_array($aa1);
            ?>

            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav nav-tab-menu">
                    <li><a href="user_dashboard.php?page=home">Dashboard</a></li>
                    <li><a href="user_dashboard.php?page=new_project">Project</a></li>  
                </ul>
            </div>
            <!-- /.navbar-collapse -->
        </div>

        ...
        <div class="tab-pane fade in active" id="series">
            ...
            <div class="col-lg-6">
				<div class="col-lg-12">
					...
					<div class="col-md-6">
						<input type="text" class="form-control" name="txt_cname" id="txt_fname" value="<?php echo $row['comp_name']; ?>" placeholder="Company Name" readonly>
					</div>
					...
					<div class="col-md-6">
						<input type="text" class="form-control" name="txt_name" id="txt_lname" value="<?php echo $row['name']; ?>" placeholder="Name" readonly>
					</div>
					<div class="panel-body"></div>
					...
					<div class="col-md-6">
						<input type="text" class="form-control" name="txt_cont" id="txt_cont" value="<?php echo $row['contact']; ?>" placeholder="Contact No" readonly>
					</div>
					<div class="panel-body"></div>
					...
					<div class="col-md-6">
						<input type="email" class="form-control" name="txt_email" id="txt_email" value="<?php echo $row['username']; ?>" placeholder="Email" readonly>
					</div>
				</div>
			</div>
			<div class="col-lg-6">
